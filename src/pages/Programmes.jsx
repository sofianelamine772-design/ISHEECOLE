...
const programmes = [
  ...
  },
  {
    ...
    title: 'Tilawa & Hifdh',
    desc: 'Mémorisation et fluidité. Pour que ta récitation devienne une véritable connexion spirituelle.',
    price: '349 €',
    items: ['Mémorisation guidée', 'Correction précise', 'Suivi personnalisé', 'Lien spirituel'],
    id: 'adult_hifdh'
  },
  {
    type: 'distanciel',
    ...
    desc: 'Fiqh Malikite, Sîrah, Arabe et Sciences du Coran. Un socle de connaissances solide et authentique.',
    price: '349 €',
    items: ['Fiqh & Aqida', 'Vie du Prophète (PSL)', 'Compréhension du Coran', 'Arabe Littéraire'],
    id: 'adult_fiqh'
  },
  {
    type: 'distanciel',
    ...
    desc: 'Méthode ludique pour les 6-15 ans. Arabe, Coran, Tajwid et Éducation Islamique.',
    price: '349 €',
    items: ['Pédagogie adaptée', 'Section Ados spécifique', 'Éducation islamique', 'WhatsApp parent'],
    id: 'kids_global'
  },
  {
    type: 'distanciel',
    category: 'OFFRE COMPLÉMENTAIRE',
    level: 'Accompagnement',
    badge: 'Soutien',
    badgeColor: 'bg-slate-100 text-slate-700',
    title: 'Pack Accompagnement',
    desc: 'Groupe WhatsApp, lives mensuels et module spiritualité exclusif pour booster ton parcours.',
    price: '49 €',
    items: ['Vivre au quotidien', 'Groupe d\'entraide', 'Cours de spiritualité', 'Accès Early Bird'],
